    ...
    <div class="row">
            ...
            <div class="col-lg-7">
              <select name="search_price" class="form-control">
                ...
                <option value="3">ksh10,000 - ksh2000,000</option>
                <option value="3">ksh200,000 - above</option>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="item active">
          <img src="images/properties/liv-4-1.jpg" class="properties" alt="properties" />
        </div>
        <!-- #Item 0 -->
