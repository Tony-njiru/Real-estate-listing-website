        ...
        <div class="sl-slider">
          ...
          <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">2 Bed Rooms and 1 Dinning Room Aparment on Sale</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Malindi,beach house </p>
              <p>Live The Luxurious Life That You Ever Wished For.</p>
              <cite>Ksh 4,000,000</cite>
              </blockquote>
            </div>
          </div>
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Mombasa, Diani luxurious beach house</p>
              <p>Ejoy The Breeze Of The Ocean In A Luxurious way, Vacations in style.</p>
          ...
          <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="-5" data-slice2-rotation="25" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span>Karen, Nairobi</p>
              <p>Silent Place to Relax Your Mind, Comfort In Style.</p>
              <cite>ksh 40,000,000</cite>
              </blockquote>
            </div>
          </div>
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-5" data-slice2-rotation="10" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Thika, Kenya</p>
              <p>Living Outside The City Is such a comfort, live In A Peaceful Enviroment.</p>
              <cite>ksh 6,000,000</cite>
              </blockquote>
            </div>
          </div>
        </div><!-- /sl-slider -->
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-4">
             <select name="search_price" class="form-control">
                <option>Price</option>
                <option value="1">ksh5000 - ksh50,000</option>
                <option value="2">ksh50,000 - ksh100,000</option>
                <option value="3">ksh100,000 - ksh200,000</option>
                <option value="4">ksh200,000 - above</option>
              </select>
            </div>
            <div class="col-lg-3 col-sm-4">
  ...
  <div class="spacer">
    <div class="row">
      <div class="col-lg-12 col-sm-12 recent-view">
        <h3>About Us</h3>
        <p>At Winner Real Estate, you are number one. Whether you are a property owner, tenant, or buyer, we value your business and will provide you with the individual attention and service you deserve. We believe in a strict Code of Ethics. We believe in integrity, commitment to excellence, a professional attitude, and personalized care.<br><a href="about.html">Learn More</a></p>
...
<div class="row">
            ...
            <div class="col-lg-3 col-sm-3">
             ...
             <div class="col-lg-3 col-sm-3">
                    <h4>Contact us</h4>
                    <p><b>TORNIE CODING</b><br>
<span class="glyphicon glyphicon-map-marker"></span>Nairobi , kimathi street, corner house, Kenya<br>
<span class="glyphicon glyphicon-envelope"></span>www.winneragents.com<br>
<span class="glyphicon glyphicon-earphone"></span> +254748203958</p>
            </div>
                   </div>
