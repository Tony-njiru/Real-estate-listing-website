...
$sql = "INSERT INTO users (fullname, lastname, address,email)";
...
<div class="row">
            ...
            <div class="col-lg-3 col-sm-3">
             ...
             <div class="col-lg-3 col-sm-3">
                    <h4>Contact us</h4>
                    <p><b>Nairobi</b><br>
<span class="glyphicon glyphicon-map-marker"></span>kimathi street, nairobi <br>
<span class="glyphicon glyphicon-envelope"></span> xyz@gmail.com<br>
<span class="glyphicon glyphicon-earphone"></span> +254515835069</p>
            </div>
        </div>
